 ...
 *            中文说明：实现 newlib 堆分配入口 _sbrk()。本工程线程内存由
 *            RT-Thread 自家堆管理（rt_system_heap_init 使用链接脚本符号
 *            __rt_heap_start__/__rt_heap_end__，见 BSP/rtthread_startup.c），
 *            newlib 的 malloc 基本不会被用到。
 ******************************************************************************
 * @attention
 *
